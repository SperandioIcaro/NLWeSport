            ...
            <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
              <div className='flex flex-col gap-2'>
                ...
                <select 
                    ...
                    name='game'
                    placeholder=''
                    className='bg-zinc-900 py-3 px-4 rounded text-sm placeholder:text-zinc-500 apparence-none'
                    defaultValue=""
                >
              ...
              <div className='grid grid-cols-2 gap-6'>
                <div className='flex flex-col gap-2'>
                  <label htmlFor='yearsPaying' className='font-semibold' >Joga há quantos anos?</label>
                ...
                <div className='flex flex-col gap-2' >
                  ...
                  <Input id='discord' name='discord' placeholder='Ex: Usuario#666' />
                </div>
              </div>
              ...
              <label className='mt-2 flex items-center gap-2 text-sm'>
                ...
                </Checkbox.Root>               Costumo usar chat de voz!
              </label>
